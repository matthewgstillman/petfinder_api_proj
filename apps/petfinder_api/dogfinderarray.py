dog_array = [
        ...
        'Akbash','Akita','Alaskan-Malamute','American-Bulldog',
        ...
        'Bedlington-Terrier','Belgian-Shepherd/Laekenois',
        'Belgian-Shepherd/Malinois','Belgian-Shepherd/Sheepdog',
        'Belgian-Shepherd/Tervuren','Bernese-Mountain Dog','Bichon-Frise','Black-and-Tan-Coonhound'
        ...
        'Border-Terrier','Borzoi','Boston-Terrier','Bouvier-des-Flanders','Boxer','Boykin-Spaniel',
        'Briard','Brittany-Spaniel','Brussels-Griffon','Bull-Terrier',
        'Bullmastiff','Cairn-Terrier','Canaan-Dog','Cane-Corso-Mastiff',
        'Carolina-Dog','Catahoula-Leopard-Dog','Cattle-Dog',
        'Caucasian-Sheepdog/Caucasian-Ovtcharka','Cavalier-King-Charles-Spaniel','Chesapeake-Bay-Retriever','Chihuahua','Chinese-Crested-Dog','Chinese-Foo-Dog','Chinook',
        'Chocolate-Labrador-Retriever','Chow-Chow','Cirneco-dell',
        ...
        'Feist','Field-Spaniel','Fila-Brasileiro',
        'Finnish-Lapphund','Finnish-Spitz',
        'Flat-Coated-Retriever','Fox-Terrier','Foxhound',
        'French-Bulldog','Galgo-Spanish-Greyhound','German-Pinscher',
        ...
        'Greyhound','Hamiltonstovare','Harrier','Havanese','Hound',
        'Hovawart','Husky','Ibizan-Hound','Icelandic-Sheepdog',
        'Illyrian-Sheepdog','Irish-Setter','Irish-Terrier',
        'Irish-Water-Spaniel','Irish-Wolfhound','Italian-Greyhound',
        'Italian-Spinone','Jack-Russell-Terrier','Jack-Russell-Terrier-(Parson)','Japanese-Chin','Jindo','Kai-Dog','Karelian-Bear-Dog',
        'Keeshond','Kerry-Blue-Terrier','Kishu','Klee-Kai','Komondor',
        'Kuvasz','Kyi-Leo','Labrador-Retriever','Lakeland-Terrier',
        'Lancashire-Heeler','Leonberger','Lhasa-Apso','Lowchen',
        'Maltese','Manchester-Terrier','Maremma-Sheepdog','Mastiff',
        'McNab','Miniature-Pinscher','Miniature-Schnauzer''Mixed-Breed',
        ...
        'Nova-Scotia-Duck-Tolling-Retriever','Old-English-Sheepdog','Otterhound','Papillon','Patterdale-Terrier/Fell-Terrier',
        'Pekingese','Peruvian-Inca-Orchid','Petit-Basset-Griffon-Vendeen','Pharaoh-Hound','Pit-Bull-Terrier','Plott-Hound','Podengo-Portugueso',
        'Pointer','Polish-Lowland-Sheepdog','Pomeranian','Poodle',
        'Portuguese-Water-Dog','Presa-Canario','Pug','Puli', 'Pumi',
        'Rat-Terrier','Redbone-Coonhound','Retriever','Rhodesian-Ridgeback','Rottweiler','Rough-Collie',
        'Saint-Bernard/St.-Bernard','Saluki','Samoyed',
        'Sarplaninac','Schipperke','Schnauzer',
        'Scottish-Deerhound','Scottish-Terrier-Scottie',
        'Sealyham-Terrier','Setter','Shar-Pei',
        'Sheep-Dog','Shepherd','Shetland-Sheepdog-Sheltie',
        'Shiba-Inu','Shih-Tzu','Siberian-Husky',
        'Silky-Terrier','Skye-Terrier','Sloughi',
        'Smooth-Collie','Smooth-Fox-Terrier','South-Russian-Ovtcharka',
        'Spaniel','Spanish-Water-Dog','Spitz','Staffordshire-Bull-Terrier','Standard-Poodle','Standard-Schnauzer','Sussex-Spaniel','Swedish-Vallhund',
        'Terrier','Thai-Ridgeback','Tibetan-Mastiff','Tibetan-Spaniel',
        'Tibetan-Terrier','Tosa-Inu','Toy-Fox-Terrier','Treeing-Walker-Coonhound','Vizsla','Weimaraner',
        'Welsh-Corgi','Welsh-Springer-Spaniel','Welsh-Terrier',
        'West-Highland-White-Terrier-Westie','Wheaten-Terrier','Whippet',
        'White-German-Shepherd','Wire-Fox-Terrier','Wirehaired-Dachshund','Wirehaired-Pointing-Griffon',
